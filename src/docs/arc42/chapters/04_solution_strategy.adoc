...
| Board Seite 6, 7, 9; Änderungsszenario QS-A-01 (zwei Monate, 20 PT); Folge 112, 22:24 bis 48:16 und 54:13 bis 58:25
...
NOTE: Offen: Die Entscheidung für Cloud-Betrieb ist in Folge 111 ausdrücklich vertagt (59:33 bis 60:31: "es ergibt sich nicht direkt, welches Betriebsmodell angeraten ist"). Das Board zu Folge 113 setzt Cloud als Maßnahme. In Folge 112 nicht behandelt; Folge 113 ausstehend. Ein ADR zum Betriebsmodell fehlt; die Risiken R-010 und R-022 in Kapitel 11 halten die Spannung zwischen lokaler Kasse und Cloud fest.

NOTE: Offen: Deployment Monolith oder Microservices ist auf dem Board nicht entschieden (Seite 10 und 11). In Folge 112 nicht behandelt; Folge 113 ausstehend. Die gelbe Notiz "ggf. finanziellen Aspekt separieren?" (Seite 9) deutet auf einen möglichen fünften Baustein hin; sie stammt nicht aus Folge 112.
