...
|Jede Entscheidung mit mehr als einer ernsthaften Option erhält einen ADR (Kontext, Optionen, Entscheidung, Konsequenzen) mit 3-Punkt-Pugh-Matrix. Stand: <<adr-001>> bis <<adr-008>>.
|`src/docs/arc42/adr/`
