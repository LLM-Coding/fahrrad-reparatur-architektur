...
*Betroffene Qualitätsszenarien:* <<10_quality_requirements.adoc#qs-u-03,QS-U-03>>, weil die Statusseite das ist, was Kund:innen nach der Reparatur vom System sehen und bewerten (R-014, R-015); <<10_quality_requirements.adoc#qs-a-01,QS-A-01>>, weil Reparaturdaten genau einen Ort haben und andere Läden mit anderen Webshops keinen Abgleich brauchen.
