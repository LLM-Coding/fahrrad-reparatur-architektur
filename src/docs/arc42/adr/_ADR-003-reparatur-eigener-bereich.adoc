...
*Betroffene Qualitätsszenarien:* <<10_quality_requirements.adoc#qs-u-02,QS-U-02>>, weil der eigene Bereich dem fachlichen Ablauf einer Reparatur folgt und der eigene Bezahlvorgang die Beauftragung in zwei Minuten nicht verlängern darf (R-008).
