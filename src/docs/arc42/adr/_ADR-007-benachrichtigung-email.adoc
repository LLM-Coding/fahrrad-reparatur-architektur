...
*Betroffene Qualitätsszenarien:* keines. Die Entscheidung folgt aus einer Randbedingung, nicht aus einem Szenario. <<10_quality_requirements.adoc#qs-u-03,QS-U-03>> nennt die Benachrichtigung als Antwort der Architektur, treibt aber nicht die Wahl des Kanals.
