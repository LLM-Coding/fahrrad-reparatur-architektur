...
*Betroffene Qualitätsszenarien:* <<10_quality_requirements.adoc#qs-z-03,QS-Z-03>>, weil die Kund:in an der Kasse wartet und der Preis der erfolgten Reparatur dort in zwei Minuten vorliegen muss; <<10_quality_requirements.adoc#qs-u-07,QS-U-07>>, weil ein Laden ohne IT-Experten keine eigene Zahlungsabwicklung betreiben kann; <<10_quality_requirements.adoc#qs-a-01,QS-A-01>>, weil jeder Laden eine andere Kasse hat und die Integration je Laden neu entsteht (R-013).
