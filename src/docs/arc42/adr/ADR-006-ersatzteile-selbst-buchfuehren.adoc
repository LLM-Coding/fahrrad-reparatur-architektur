...
*Betroffene Qualitätsszenarien:* <<qs-u-07>>, weil ein Inventarsystem weniger ein System weniger ist, das der Laden ohne IT-Experten betreiben müsste; <<qs-a-01>>, weil Läden mit eigenem Inventarsystem als SaaS-Kunden auf die Eigenlösung treffen (R-018).
