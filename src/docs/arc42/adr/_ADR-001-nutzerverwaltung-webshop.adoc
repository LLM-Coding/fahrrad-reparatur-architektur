...
*Betroffene Qualitätsszenarien:* <<10_quality_requirements.adoc#qs-u-01,QS-U-01>>, weil die Registrierung im Webshop bleibt und das Szenario im Reparatursystem damit nicht erfüllbar ist; <<10_quality_requirements.adoc#qs-u-02,QS-U-02>>, weil Login und vorbelegte Adresse aus dem Webshop die Beauftragung in zwei Minuten erst möglich machen; <<10_quality_requirements.adoc#qs-z-04,QS-Z-04>>, weil der Web-Login mit dem Webshop ausfällt (R-002); <<10_quality_requirements.adoc#qs-a-01,QS-A-01>>, weil die feste Kopplung an diesen einen Webshop den Umbau zum SaaS verteuert (R-003).
