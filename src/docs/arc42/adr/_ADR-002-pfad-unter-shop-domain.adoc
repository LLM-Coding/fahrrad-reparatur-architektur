...
| Status | Accepted
| Datum | 2022-02-25
| Quelle | software-architektur.tv Folge 111, 29:32 und 31:24
|===
...
*Betroffene Qualitätsszenarien:* <<10_quality_requirements.adoc#qs-u-02,QS-U-02>>, weil der Login aus dem Webshop nur unter derselben Domain durchläuft und Kund:innen sich sonst ein zweites Mal anmelden müssten; <<10_quality_requirements.adoc#qs-a-01,QS-A-01>>, weil jeder weitere Laden eine eigene Umleitung unter seiner Domain braucht (R-006).
...
Die Entscheidung folgt aus <<adr-001>>. Die Integration mit dem Webshop "funktioniert darüber, dass wir bestimmte URLs umleiten an unser Reparatursystem" (29:36). Eberhard zieht die Grenze klar: "innerhalb von meintollerfahrradshop.de gibt es Slash Reparatur und Slash Reparatur ist unsere Verantwortung" (29:42).
