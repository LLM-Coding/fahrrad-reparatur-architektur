...
*Betroffene Qualitätsszenarien:* <<qs-u-02>>, weil der Login aus dem Webshop nur unter derselben Domain durchläuft und Kund:innen sich sonst ein zweites Mal anmelden müssten; <<qs-a-01>>, weil jeder weitere Laden eine eigene Umleitung unter seiner Domain braucht (R-006).
